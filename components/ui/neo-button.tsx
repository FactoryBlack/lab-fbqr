...
const neoButtonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap text-base font-bold ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 w-full border-2 border-neo-text font-sans",
  {
    variants: {
      variant: {
        default: "bg-neo-accent text-neo-text hover:bg-neo-accent/90",
        destructive: "bg-neo-destructive-accent text-neo-text hover:bg-neo-destructive-accent/90",
        outline: "bg-transparent hover:bg-neo-text/5",
        secondary: "bg-neo-interactive-bg text-neo-text hover:bg-neo-bg",
