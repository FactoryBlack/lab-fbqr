...
export default function QRGeneratorPage() {
  ...
  return (
    <>
      ...
      <div className="bg-[var(--neo-bg)] min-h-screen flex flex-col">
        <header className="flex items-center justify-between w-full flex-shrink-0 p-6">
        ...
        <main className="flex-1 grid lg:grid-cols-[400px_1fr_400px] min-h-0 w-full max-w-[1920px] mx-auto">
          {/* Desktop Layout */}
          ...
          <div className="hidden lg:flex items-center justify-center p-6 min-h-0">
        ...
        <footer className="h-4 bg-[var(--neo-text)] w-full flex-shrink-0" />
      </div>
    </>
  )
}
